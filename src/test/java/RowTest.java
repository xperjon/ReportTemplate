...
public class RowTest {
    ...
    public void matchingHeaderRows() {
        Row row1 = new Row(RowType.SR3, "Foo", (row, report) -> Optional.empty(), (r) -> "", Optional.empty());
        Row row2 = new Row(RowType.RR3, "Bar", (row, report) -> Optional.empty(), (r) -> "", Optional.empty());
        assertEquals(true, row1.isMatchingHeaderRow(row2));
        assertEquals(true, row2.isMatchingHeaderRow(row1));
        Row row3 = new Row(RowType.SR1, "Foo", (row, report) -> Optional.empty(), (r) -> "", Optional.empty());
        Row row4 = new Row(RowType.RR1, "Bar", (row, report) -> Optional.empty(), (r) -> "", Optional.empty());
    ...
    public void nonMatchingHeaderRows() {
        Row row1 = new Row(RowType.SR2, "Foo", (row, report) -> Optional.empty(), (r) -> "", Optional.empty());
        Row row2 = new Row(RowType.RR3, "Bar", (row, report) -> Optional.empty(), (r) -> "", Optional.empty());
        assertEquals(false, row1.isMatchingHeaderRow(row2));
        assertEquals(false, row2.isMatchingHeaderRow(row1));
        Row row3 = new Row(RowType.SR3, "Foo", (row, report) -> Optional.empty(), (r) -> "", Optional.empty());
        Row row4 = new Row(RowType.RR1, "Bar", (row, report) -> Optional.empty(), (r) -> "", Optional.empty());
